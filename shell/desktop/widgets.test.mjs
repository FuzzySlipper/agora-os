...
assert.equal(container.dataset.visualId, "widget_weather");
assert.equal(container.dataset.visualRole, "widget");
assert.equal(container.dataset.testid, "widget_weather");
